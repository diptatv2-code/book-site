  ...
  return (
    <>
      ...
      <section className="relative flex min-h-screen items-center overflow-hidden">
        ...
        {/* Gold accent lines */}
        <div className="absolute left-0 top-1/4 h-px w-32 bg-gradient-to-r from-transparent to-gold/20" />
        <div className="absolute right-0 top-1/3 h-px w-32 bg-gradient-to-l from-transparent to-gold/20" />
        <div className="absolute bottom-1/4 left-0 h-px w-48 bg-gradient-to-r from-transparent to-gold/20" />
          ...
          <div className="flex flex-col items-center gap-12 lg:flex-row lg:gap-20">
            ...
            <div className="animate-fade-in-up book-3d flex-shrink-0">
              <div className="book-3d-inner relative">
                {/* Book shadow */}
                <div className="absolute -bottom-6 left-4 right-4 h-8 rounded-full bg-gold/10 blur-2xl" />
                {/* Book glow */}
                <div className="absolute -inset-1 rounded-lg bg-gradient-to-b from-gold/20 via-transparent to-gold/10 blur-sm" />
                <Image
            ...
            <div className="text-center lg:text-left">
              <div className="animate-fade-in-up delay-100">
                <p className="font-ui text-sm font-medium uppercase tracking-[0.3em] text-gold">
              ...
              <h1 className="animate-fade-in-up delay-200 mt-6 font-heading text-4xl font-bold leading-tight sm:text-5xl lg:text-6xl">
                <span className="gold-shimmer">A Short Journey</span>
                <br />
                <span className="text-text">Through The Quran</span>
              </h1>

              <p className="animate-fade-in-up delay-300 mt-4 font-heading text-xl font-light italic text-gold-light sm:text-2xl">
                An Introduction
              </p>

              <p className="animate-fade-in-up delay-400 mt-6 max-w-lg font-body text-lg leading-relaxed text-text-muted">
              ...
              <div className="animate-fade-in-up delay-500 mt-8 flex flex-col gap-4 sm:flex-row sm:justify-center lg:justify-start">
                <a
                  href="#where-to-buy"
                  className="gold-glow inline-flex items-center justify-center rounded-full bg-gold px-8 py-3.5 font-ui text-sm font-semibold text-[#0a0a0a] transition-all hover:bg-gold-light hover:shadow-lg"
                >
                  Buy Now
                </a>
                <Link
      ...
      <section className="relative py-24">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="animate-fade-in-up delay-200 mt-12 space-y-6 text-center">
      ...
      <section className="relative bg-gradient-to-b from-[#0a0a0a] via-[#0d1117] to-[#0a0a0a] py-24">
        <div className="geometric-pattern absolute inset-0 opacity-50" />
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div className="animate-slide-in-left">
              <Image
                ...
                width={480}
                height={800}
                className="mx-auto rounded-lg shadow-2xl shadow-gold/5"
            ...
            <div className="animate-slide-in-right space-y-6">
              ...
              <div className="h-1 w-16 rounded bg-gold/40" />
              <p className="font-body text-lg leading-relaxed text-text-muted">
      ...
      <section className="py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="animate-fade-in-up text-center">
            ...
            <div className="mx-auto mt-4 h-1 w-16 rounded bg-gold/40" />
            <p className="mt-4 font-body text-lg text-text-muted">
          ...
          <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {highlights.map((item, i) => (
              <div
                key={item.title}
                className={`animate-fade-in-up delay-${(i + 1) * 100} gold-glow group rounded-xl border border-border/50 bg-card/50 p-8 transition-all duration-300 hover:-translate-y-1 hover:border-gold/30`}
              >
                <div className="flex h-14 w-14 items-center justify-center rounded-lg bg-gold/10 text-2xl transition-colors group-hover:bg-gold/20">
                  {item.icon}
                </div>
      ...
      {/* Where to Buy */}
      <section id="where-to-buy" className="bg-gradient-to-b from-[#0a0a0a] to-[#0d1117] py-24">
          ...
          <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {retailers.map((retailer, i) => (
              <a
                ...
                className={`animate-fade-in-up delay-${(i + 1) * 100} gold-glow group flex flex-col items-center rounded-xl border border-border/50 bg-card/50 p-8 text-center transition-all duration-300 hover:-translate-y-1 hover:border-gold/30`}
              >
                <div className="flex h-16 w-16 items-center justify-center rounded-full bg-gold/10 text-3xl transition-colors group-hover:bg-gold/20">
                  {retailer.icon}
                </div>
                <h3 className="mt-4 font-heading text-lg font-bold text-text">
                  {retailer.name}
                </h3>
                <p className="mt-1 font-ui text-xs text-text-muted">{retailer.note}</p>
                <span className="mt-4 font-ui text-sm font-medium text-gold transition-colors group-hover:text-gold-light">
                  Shop Now &rarr;
                </span>
              </a>
            ))}
      ...
      <section className="py-24">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="animate-fade-in-up delay-200 mt-12 overflow-hidden rounded-xl border border-border/50 bg-card/30">
            <div className="grid divide-y divide-border/30 sm:grid-cols-2 sm:divide-x sm:divide-y-0">
              {bookDetails.map((detail) => (
                <div key={detail.label} className="flex items-center gap-4 p-6">
                  <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg bg-gold/10 text-lg">
                    {detail.icon}
                  </div>
                  <div>
                    <p className="font-ui text-xs font-medium uppercase tracking-wider text-text-muted">
                      {detail.label}
                    </p>
                    <p className="mt-0.5 font-heading text-lg font-semibold text-text">
                      {detail.value}
                    </p>
                  </div>
                </div>
      ...
      <section className="relative overflow-hidden py-24">
        <div className="geometric-pattern absolute inset-0" />
        <div className="absolute inset-0 bg-gradient-to-b from-[#0a0a0a] via-[#0d1117]/90 to-[#0a0a0a]" />
        <div className="relative mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
          <h2 className="animate-fade-in-up font-heading text-3xl font-bold sm:text-4xl">
            Begin Your{" "}
            <span className="gold-shimmer">Journey</span>
          </h2>
          <p className="animate-fade-in-up delay-200 mt-4 font-body text-lg text-text-muted">
          ...
          <div className="animate-fade-in-up delay-300 mt-8 flex flex-col justify-center gap-4 sm:flex-row">
            <a
              href="#where-to-buy"
              className="gold-glow inline-flex items-center justify-center rounded-full bg-gold px-10 py-4 font-ui text-sm font-semibold text-[#0a0a0a] transition-all hover:bg-gold-light"
            >
              Get Your Copy
            </a>
            <Link
              href="/contact"
              className="inline-flex items-center justify-center rounded-full border border-gold/40 px-10 py-4 font-ui text-sm font-semibold text-gold transition-all hover:border-gold hover:bg-gold/10"
            >
              Contact the Author
            </Link>
          </div>
...
const bookDetails = [
  { icon: <span className="text-gold">&#x1D54B;</span>, label: "Title", value: "A Short Journey Through The Quran" },
  { icon: <span className="text-gold">&#x270D;</span>, label: "Author", value: "Tanbirul Quadir Choudhury" },
  { icon: <span className="text-gold">&#x1F4C4;</span>, label: "Pages", value: "~110" },
  { icon: <span className="text-gold">&#x1F4D6;</span>, label: "Format", value: "Paperback / eBook" },
  { icon: <span className="text-gold">&#x1F310;</span>, label: "Language", value: "English" },
  { icon: <span className="text-gold">&#x2B50;</span>, label: "Chapters", value: "11 + 3 Appendices" },
];
